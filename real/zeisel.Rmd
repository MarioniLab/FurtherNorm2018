...
lapply(all.sf, FUN=clusterBias, counts=counts, clust=cell.types, 
    threshold=0.1, ref="oligodendrocytes")
```

Indeed, we can see that library size normalization exhibits 20-40% bias for every cluster compared to oligodendrocytes.
