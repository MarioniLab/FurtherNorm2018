...
Indeed, we can see that library size normalization exhibits a ~20% bias for one of the clusters.
...
res.q <- testDE(subcounts, sf.q, is.oligo, is.pyramidal)
...
res.d <- testDE(subcounts, sf.d, is.oligo, is.pyramidal)
